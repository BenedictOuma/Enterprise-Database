...
-------------------creating customers table and inserting data into it----------------------
...
---cast is for changing commission from maybe decimal to int, e.g above could also be (o.OrderQuantity * p.ProductPrice+ o.ShippingFee)*0.05 as Commission but would give a decimal value
...
select top 3 
	...
	count(od.OrderID) as TotalOrders  ---not much necessary
